...
resource "aws_ec2_transit_gateway_route" "us_east_1_to_runtime_ec2_us_west_2" {
...
resource "aws_ec2_transit_gateway_route" "us_east_1_to_runtime_eks_eu_west_1" {
...
resource "aws_ec2_transit_gateway_route" "us_east_1_to_runtime_ec2_eu_west_1" {

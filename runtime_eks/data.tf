...
locals {
  ...
  boundary_worker_vault_namespace          = data.terraform_remote_state.shared_services_vault.outputs.boundary_worker_namespace_relative
  boundary_worker_vault_namespace_absolute = data.terraform_remote_state.shared_services_vault.outputs.boundary_worker_namespace

...
module "us_east_1" {
  ...
  consul_public_address  = local.consul_us_east_1.address
...
module "us_west_2" {
  ...
  consul_public_address  = local.consul_us_west_2.address
...
module "eu_west_1" {
  ...
  consul_public_address  = local.consul_eu_west_1.address
